...
// Dribbble widget for wilson WordPress theme
...
class wilson_dribbble_widget extends WP_Widget {
	...
	function __construct() {
        $widget_ops = array( 'classname' => 'wilson_dribbble_widget', 'description' => __('Displays your latest Dribbble photos.', 'wilson') );
        parent::__construct( 'wilson_dribbble_widget', __('Dribbble Widget','wilson'), $widget_ops );
    }
	...
	function widget($args, $instance) {
		...
		$widget_title = null; $dribbble_username = null; $dribbble_number = null; $unique_id = null;
		...
		if (!empty($widget_title)) {
			...
			if (!empty($items)): ?>
				...
				<div class="dribbble-container">
					...
					<p class="widgetmore"><a href="http://www.dribbble.com/<?php echo $dribbble_user; ?>"><?php printf( __('Follow %s on Dribbble &raquo;','wilson'), $dribbble_username); ?></a></p>
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo $this->get_field_id('dribbble_username'); ?>"><?php  _e('Dribbble username', 'wilson'); ?>:
		...
		<p>
			<label for="<?php echo $this->get_field_id('dribbble_number'); ?>"><?php _e('Number of images to display:', 'wilson'); ?>
...
register_widget('wilson_dribbble_widget'); ?>